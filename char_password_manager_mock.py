...
def handler():
    valid_inputs = {'e': insert_secret , 'r': retrieve_secret, 'd': delete_secret, 'l': list_secrets}

    user_input = input("Please specify [e]ntry, [r]etrieval, [d]eletion, [l]isting or e[x]it:").lower()
...
def retrieve_secret():
    try:
        secret_identifier = input('What is the name of the secret you would like to retrieve?')
        ...
        secret_txt.write(f'User ID = {secret["user_id"]} \nPassword = {secret["password"]}')
        secret_txt.close()
